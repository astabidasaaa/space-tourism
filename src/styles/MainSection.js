...
export const MainSection = styled.section(({ page }) => [
  ...
  page === "technology" &&
    tw`gap-[32px] pt-[88px] pb-[60px] px-[24px] sm:gap-[60px] sm:pt-[136px] sm:pb-[98px] sm:px-[38px] lg:px-[166px] lg:pt-[212px] lg:pb-[100px]`,
]);

// tw`box-border bg-cover bg-scroll bg-center select-none pointer-events-none absolute top-0 right-0 z-[-99] w-full h-full`,
